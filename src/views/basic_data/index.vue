              ...
              <div class="block">
                ...
                <div class="add">
                  ...
                  <el-form v-model="newChild">
                    <el-form-item label="选择关联项" :label-width="formLabelWidth" style="margin-left: 0">
                      <el-cascader
                        :options="data"
                    ...
                    <el-form-item label="指标/指标选项" :label-width="formLabelWidth" style="margin-left: 0">
  ...
  methods: {
    ...
    */
    ...
    getData(){
      return  {
        id: id++,
        label: this.newChild.label,
        //dataOptions: this.newChild.options.split('；'),
        relevanceID: this.newChild.relevanceID,
      }
    },
    remove (node, data) {
    ...
    converterRelevanceID(){
      let relevanceID=this.newChild.relevanceID
      this.newChild.relevanceID=[]
      relevanceID.forEach(relevance=>{
        this.newChild.relevanceID.push(relevance.pop())
      })
    },
    testEmpty() {
      //判断输入是否为空
